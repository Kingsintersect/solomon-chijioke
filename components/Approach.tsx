...
const Approach = () => {
    return (
        <section className="w-full py-20">
            ...
            <p className="text-xl text-center mt-5">Sumarized in three steps...</p>
            <div className="my-20 flex flex-col lg:flex-row items-center gap-4">
                <Card
                    title="Planning & strategy"
                    icon={<AceternityIcon order="Phase 1" />}
                    description={"Lorem, ipsum dolor sit amet consectetur adipisicing elit. Enim officiis rem ipsum illum, est magni molestiae vitae cupiditate, suscipit libero ipsam in eos at."}
                >
                    <CanvasRevealEffect
                        animationSpeed={5.1}
